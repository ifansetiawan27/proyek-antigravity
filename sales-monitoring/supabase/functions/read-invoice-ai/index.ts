...
Ambil HANYA:
1. Nama pemesan/pembeli/customer yang tercantum pada faktur. Untuk format faktur ini, prioritaskan teks BOLD/TEBAL yang posisinya tepat di bawah label "Kepada :" sebagai nama pemesan. Jangan gunakan header tabel, alamat, nomor telepon, email, tanggal, atau teks biaya sebagai nama pemesan.
