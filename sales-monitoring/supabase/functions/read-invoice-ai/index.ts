...
2. SEMUA nama barang/produk/alkes/obat dari setiap baris item penjualan, bukan hanya barang pertama atau barang yang dikenal. Periksa seluruh halaman dan seluruh baris tabel. Kembalikan nama barangnya saja. Hapus kode barang dalam format apa pun, termasuk kode alfanumerik tanpa pemisah seperti BBS017 atau SKU001, kode dengan tanda hubung, SKU, item code, nomor urut, qty, satuan, merek pada kolom terpisah, dan nilai lain dari kolom tabel.
3. Total akhir yang harus dibayar (prioritaskan Grand Total/Total Tagihan/Amount Due, setelah diskon dan pajak).
Teks "Nama", "Biaya", "Jumlah", "Penggantian", "Biaya Pengiriman", "Biaya Lain-lain", "Biaya Lainnya", ongkir, shipping fee, delivery fee, other charges, dan other fees BUKAN nama barang dan tidak boleh dimasukkan ke items.
Jangan ambil kode barang/SKU/item code, nama klinik, rumah sakit, dokter, sales, nomor faktur, tanggal, alamat, subtotal, pajak, diskon, harga satuan, qty, satuan, biaya pengiriman, biaya lain-lain, ongkir, atau jumlah per baris sebagai items.
